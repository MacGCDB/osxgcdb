...
@implementation Cachelog

@dynamic groundspeak_date;
@dynamic groundspeak_finder;
@dynamic groundspeak_finder_id;
@dynamic groundspeak_log_id;
@dynamic groundspeak_text;
@dynamic groundspeak_text_encoded;
