//
//  Pocketqueries+categories.m
//  osxgcdb
//
//  Created by MacGCDB (macgcdb@googlemail.com) on 3-9-12.
...
#import "Pocketqueries+categories.h"

@implementation Pocketqueries (categories)
...
- (void) setTestUpdated:(NSDate*)input {
