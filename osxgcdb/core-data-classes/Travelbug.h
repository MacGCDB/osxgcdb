...
@interface Travelbug : NSManagedObject

@property (nonatomic, retain) NSString * groundspeak_travelbug_id;
@property (nonatomic, retain) NSString * groundspeak_travelbug_name;
@property (nonatomic, retain) NSString * groundspeak_travelbug_ref;
