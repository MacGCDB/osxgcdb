...
@interface Waypoint (Categories)

@property (nonatomic, retain) NSNumber* distanceFromHome;

@property (nonatomic, retain) NSString* bearingFromHome;
