...
@interface gcdbPreferenceController : NSWindowController <CLLocationManagerDelegate> {

    CLLocationManager *locationManager;
    
    IBOutlet NSTextField *localLat;
    IBOutlet NSTextField *localLon;
